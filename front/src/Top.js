    ...
    <Formik
      ...
      onSubmit={(values, actions) => {
        ...
        setTimeout(() => {
          ...
          fetch("https://sd.tokyo-tsushin.com/api/txt2img", {method: 'POST', headers:{'Content-Type': 'application/json'}, body: JSON.stringify(values, null, 2)})
          .then(res => res.json())
          .then(json => {
            console.log("json");
            console.log(json);
            ...
            window.location.href = '/front/txt2img/' + json.filename;
          });
